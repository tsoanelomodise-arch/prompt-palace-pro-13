      ...
      <div className="flex items-end justify-between gap-6 mb-10 pb-8 border-b border-border">
        <div>
          ...
          <p className="mt-3 text-muted-foreground max-w-xl">
            Every prompt the team has written. Search, refine, and fill in the blanks.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-3 md:items-center mb-8">
        ...
        {categories.length > 0 && (
          <div className="flex flex-wrap gap-2">
            <CatChip active={!activeCat} onClick={() => setActiveCat(null)}>All</CatChip>
            {categories.map((c) => (
  ...
  return (
    <div className="border border-dashed border-border rounded-lg p-12 text-center">
      ...
      <p className="mt-1 text-sm text-muted-foreground">
        {hasPrompts ? "Try a different search." : "Add the first prompt to get the library going."}
      </p>
      {!hasPrompts && (
